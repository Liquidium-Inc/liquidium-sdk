...
Before you create the loan, make sure that the borrow amount meets the SDK minimum for the selected asset. If your UI shows the minimum, use `getMinimumBorrowAmount(borrowPool.asset)`.
