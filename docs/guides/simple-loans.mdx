...
The Liquidium SDK API rejects native ETH borrow destinations with deployed bytecode before creating a loan. Simple Loan callers do not need an EVM client for this check.
